<?php
session_start();
$imie_prowadzacego = $_POST['imie_prowadzacego']; // pobranie danych z formularza
$nazwisko_prowadzacego = $_POST['nazwisko_prowadzacego'];
$jednosta_organizacyjna = $_POST['jednosta_organizacyjna'];
...
try
{
	...
	else
	{
		...
		if ($wszystko_ok == true)
		{
			...
			if ($polaczenie->query("INSERT INTO prowadzacy VALUES (NULL,'$imie_prowadzacego','$nazwisko_prowadzacego','$jednosta_organizacyjna','$stanowisko','$email','$strona_www')"))
			{
				echo "Dodano do bazy";
			}
			else
