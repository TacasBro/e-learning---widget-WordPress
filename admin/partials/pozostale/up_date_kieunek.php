...
session_start();       
        ...
        }elseif(!preg_match($sprawdz, $nazwa_kierunku)) 
        {
           ...
           "Nazwa kierunku zawiera niedozwolone znaki";
        }
        ...
        try{
                ...
                if($polaczenie->query("UPDATE kierunek SET id_wydzialu='$wydzial',nazwa_kierunku='$nazwa_kierunku' WHERE id_kierunku='$id'"))
                        {
            ...
            echo "Przepraszamy spróbuj jeszcze raz";
        }      
